// The GhostPhysics class for an entity
(function() {
    var GhostPhysics = function(entity) {
        GhostPhysics.G = 10;   // The gravity constant
     ...
     */
    GhostPhysics.prototype.update = function() {
        var v0 = this.v;
     ...
     */
    GhostPhysics.prototype.applyForces = function() {
     ...
     */
    GhostPhysics.prototype.applyGravity = function() {
        this.a.y += this.mass * GhostPhysics.G;
    };

    /**
     * Adds a force at the current moment
     */
    GhostPhysics.prototype.addForce = function(x, y) {
     ...
     * @return {boolean}
     */
    GhostPhysics.prototype.hCollisions = function(v0) {
     ...
     * @return {boolean}
     */
    GhostPhysics.prototype.vCollisions = function(v0) {
    ...
    Game.GhostPhysics = GhostPhysics;
})();