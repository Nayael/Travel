...
(function() {
    var View = function(entity, data) {
        ...
        this.frame       = 0;     // The current frame to draw
    ...
    View.prototype.draw = function(context) {
        ...
        context.drawImage(this.sprite, this.width * this.frame, 0, this.width, this.height, globalX, globalY, this.width, this.height);
        this.frameCount++;
        ...
        if (this.frame >= (this.totalFrames - 1)) {   // Go back to the first frame
            this.frame = 0;
        }
    };
